 ...
 * CTSettings
 * 
 * @package CryptText CMS
 * @author Ramin Farmani (ramin@farmani.ir)
 * @copyright CryptText CMS (www.cryptext.org)
 * @version 1.2
 * @since 1.0
 * @access public
 *
 * */
class CTSettings extends CApplicationComponent {
